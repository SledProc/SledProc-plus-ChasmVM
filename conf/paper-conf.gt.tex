...
features \citeLocator{NCDataIntegration}(pp.134--143).
...
i.e., supplying the left side of a \eI{CLASS::*METHOD-PTR} construction).
...
\q{hooks} which observer code can identify (and maybe inject other code) either via
