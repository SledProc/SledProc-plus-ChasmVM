...
\textit{some} instances for a given type. In most
...
second to the value type. For invertability,
the two lists must be the same size. The most
direct implementation \mdash{} uncluttered by sanity
checks \mdash{} would simply assume this as a precondition.
}% end paragraph 
...
via \eH{if}\eH{then} tests is better than blind faith, all else being
