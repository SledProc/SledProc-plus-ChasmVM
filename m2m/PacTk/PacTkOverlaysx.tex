...
\node [draw=red!60!black, fill=blue, anchor = south west, rounded corners,
text width=13.1cm, inner sep=17pt, xshift=-8pt, yshift=-8pt, font={\fontsize{9}{9}\selectfont}] (ltext)
...
\node [draw=red!60!black, fill=blue, anchor = south west, rounded corners,
text width=13.8cm, inner sep=17pt, xshift=-8pt, yshift=-8pt, font={\fontsize{9}{9}\selectfont}] (ltext)
(s1) at (6.74, 1.9) {{The specific subject-matter of 
...
\node [draw=red!60!black, fill=white, anchor = south west, rounded corners,
text width=13.7cm, inner sep=13pt, font={\fontsize{9}{9}\selectfont}] (ltext-outer)
 at (6.73, 1.8) {{The specific subject-matter of 
environmental pollution and its relation to cancer 
incidents gives rise to software requirements which, 
ideally, are more specific than basic GIS functionality.  
Each geospatial area can be correlated with both 
