...
(such as social media, chat rooms, \GIT{} documentation, etc.) 
...
requirements (Figure~\ref{fig:car} is an example).  For instance, 
cancer varieties 
...
\p{\counterex{} The graphic pictured in Figure~\ref{fig:pcbi} is taken 
...
simulation's logic (in Figure~\ref{fig:pcbi}'s example, 
...
Here in the current document, Figures~\ref{fig:ss8} and \ref{fig:car} are taken from ProPublica 
...
included, although (as in the bottom portion of Figure~\ref{fig:car}) researchers can locate related 
...
(left part of Figure~\ref{fig:oh}) as 
