...
(now succeeded by the National Cancer Informatics 
...
\pseudoIndent{}  Controlled vocabularies and other semantic 
standards certainly apply to the familiar elements 
of computer code --- procedures, classes, data types, 
inheritance/containment hierarchies, pre- and post-conditions, etc. 
--- but in a \q{research grid} context graphical displays 
