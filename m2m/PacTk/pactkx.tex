...
in sequence (or, in some cases, both).  Discursive structures such as 
citations, quotations (with ellipsis and emendation protocols), 
and terms or proper names matching index headings are modeled 
as class-instances computationally isolated from surrounding 
...
tags (although, as mentioned previously, such tags are optional 
...
italics, underline, boldface, code excerpts, hyperlinks, 
...
\p{\textbf{LaTeX}: Although \XML{}-based technologies 
(including \XSLFO{}, which uses style-sheet transforms to 
convert formats like \JATS{} to final publications) 
...
grid uses cases for natural sciences have analogs in social 
science and humanities as well:
...
Dissemination is not \textit{only} replication.
...
institutions agree to use common protocols 
...
similarly to artistic and archaeological artifacts.  
Also, digital twins to historic papers --- whether 
as images, transcribed to text, or both --- typically 
need more detailed markup than manuscripts prepared 
...
documents, old photographs or videos sometimes need 
analysis and preservation, a process that often includes 
picture or video annotations.  Actions such as showing or hiding 
annotations, extracting video frames, navigating within image 
series, or executing image-processing algorithms, all 
require \GUI{}s that not only show the relevant 
media content but also have interactive capabilities.  
Moreover, image analysis often comes into play in fields within  
...
philosophical; while \q{hard} science often narrows in on very specific research questions/experiments).  
...
in the humanities.  \makebox{For instance, the book referenced on page \Athref{page.10}{10}} weaves together 
