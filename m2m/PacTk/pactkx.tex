...
interoperable, and reusable data sets goes beyong 
...
graphics that are pedagagoically analogous 
...
to a hospital database.  Although these usage and semantic details may 
...
page could be integrated, and accessed 
...
tracking carcinogens in air or ground polution plus 
...
requirements.  For instance, oncological labels 
...
be incporated into software that works 
with multiple repositories curated 
...
software initiatives --- e.g., the \CaBIG{} Digital Model 
Repository (\DMR{}) mentioned on the previous page  
