...
\newcommand{\counterx}[1]{\textcolor{red!30!black}{#1}}
...
\pseudoIndent{} When reaching that point in the manuscript, 
...
\counterex{} The graphic pictured in Figure~\ref{fig:pcbi} is taken 
...
\pseudoIndent{} More substantially, the process of actually 
...
\mic{} According to \FAIR{} standards, the process of 
...
Once the actual source code is downloaded, \FAIR{} principles suggest 
...
More precisely, notice that there are several interrelated assets 
...
simulations \q{business logic} (in Figure~\ref{fig:pcbi}, 
this code performs calculations like computing iteration 
updates and preparing values for a differential equation solver).  
...
In terms of search and indexing, all four components 
...
be annotated on the \Cpp{} files directly and 
then read/indexed when the overall package is 
...
In this sense, \GUI{} forms are not grid assets \textit{per se}, 
...
\counterex{} Several open-source \EMR{} and Hospital 
...
\pseudoIndent{} Taking FreeMedForms and OpenHospital as 
...
\pseudoIndent{} Another issue evident with FreeMedForms 
...
\mic{} A \FAIR{} grid approach to \EMR{}s would 
...
\pseudoIndent{} The facets in which forms are \textit{not} autonomous 
...
\pseudoIndent{} Where plugins \textit{should} be used is 
