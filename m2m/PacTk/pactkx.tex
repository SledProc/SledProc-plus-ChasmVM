...
that tields or supports conclusions presented 
...
can then examine (and possibly reproduce) that 
analysis in depth.  Ideally, researchers could 
rerun essentially the exact same code, perhaps 
usinf new data sets or tweaking parameters to 
examine the robustness/flexibility of theoretical 
models.  Data transparency is also served, however, 
by researchers obtained simplified versions 
...
code and statistical graphics.  To the degree 
...
dependency relations, lexical morphology, 
and vocal inflection, and enunciation stress patterns/meter.  
...
series, or executing image-processing algorithms, are 
require \GUI{}s that not only show the relevant 
media content but also have interactive capabilities.  
Image analysis often comes into play in the fields 
of cognitive science/phenomenology.  For example, 
Computer Vision algorithms can be used to emulate 
...
can functionally or neurologically model activity within eyes and brains. 
...
factors alongside purely scientific ones.  Public health teams, 
...
include one or more individuals with a humanistic (instead of 
or in additional scientific) background to focus on social impact.
...
philosophical; scientists often narrow in on very specific research questions/experiments).  
...
topics of law, ethnometholody, popular media, and others; it endorses certain 
