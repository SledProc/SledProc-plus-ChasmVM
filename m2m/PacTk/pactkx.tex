...
\pseudoIndent{}  In particular, we propose a \q{\GUI{} Semantic Indexing  
Protocol} (\GSix{}) to standardize \Cpp{} 
code annotations according to \FAIR{}data principles, 
with an emphasis on contract specifications and semantics applied 
to \GUI{} components.  The \GSix{} protocol 
...
In addition to \GUI{} code specifically, \GSix{} would address 
...
\sstitle{\hspace*{-50pt}PacTk's Proposed \q{FAIRgrid/Microcomponent/GUI Semantic Indexing} (FAIR/mG6)}
...
\PacTk{}'s \FAIRmgSix{} model extends the aforementioned 
\GSix{} protocol to research-grid nodes --- sometimes 
called \q{Executable Research Objects.}  In this form of shared 
data, publications and accompanying materials are bundled into a 
single downloadable application.}
...
we intend to annotate the relevant classes with \FAIRgml{} metadata.}
...
\FAIRgml{} would employ code annotations to specify this metadata 
...
for proposed \FAIRgml{} indexing, including textural segmentation 
