...
Natural Language Processing (which can aid in the 
analysis of syntactic, semantic, prosodic, and parsing 
structures) and corpora curation/maintenance; in 
both cases textual content must be represented 
in a structured manner suitable for annotation 
metadata to track (e.g.) parts of speech, 
dependency-grammar relations, lexical morphology, 
