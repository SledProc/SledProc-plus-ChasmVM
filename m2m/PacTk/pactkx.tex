...
author's vision.  As such, \PacTk{} makes 
pains to support \LaTeX{} generation and 
to allow arbitrary \LaTeX{} code to be embedded 
in \PacTk{} input sources (without 
affecting the extraction of language/discource 
content proper for \TSOM{} modeling).}

\p{With that said, \LaTeX{} is a problematic 
option for \textit{internal} text representation.  
...
Use-cases for \PacTk{} in the context of scientific grid computing 
...
linguistic/acoustic samples have similar requirements, 
whether their content is recent or historic.
