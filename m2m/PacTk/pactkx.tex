...
expressed in single-disciplinary terms, nor does an individual's 
...
\par\noindent\vspace*{-17.5pt}\textcolor{white}{\rule{\textwidth}{0.4pt}}
...
left in the above graphic\footnote{Amy Neustein 
...
(and as acknowledged by \AItwo{}) had inconsisten (\PDF{}-based) text 
extraction; in the aforementioned analysis the authors gave one example of a 
...
overlap on that common semantic element to go un-recognized by 
...
appropriate standard of representation}\footnote{Lucy Lu Wang, \textit{et al.}, 
...
{\semihr{0.289\textwidth}}
\vspace*{5pt}
\hspace{2pt}\secttitle{{Extending Beyond Single Documents}}\sstitletri{7}\sstitletri{2}\sstitletri{2}
\vspace*{5pt}
{\semihr{0.289\textwidth}}
...
\p{Although all biomedical research (and scientific work in general) 
is motivated in principle by practical benefits, translational 
emphases promote the informatics and institutional foundations 
to ensure that \q{bench to bedside} translation 
occurs as quickly and comprehensively as possible.  
Scholars in the field of \q{translational science,} for 
example, have developed a five-part model of the 
evolution of practical interventions,\footnote{Also 
...
{https://www.iths.org/investigators/definitions/translational-research}} of which the 
...
(e.g., not restricted to experimental protocols 
available only in a few hospitals).  
Such models suggest roadmaps to help 
guide deployment once research progresses through  
stages of concrete implementation.}

\p{Apart from such theoretical models, however, the 
key details of translational deployment are often 
institutional and socioeconomic in nature.  
Sustaining a research project long enough to 
rigorously assess empirical outcomes is a different 
process than procuring funding, labs, and teams 
to work through the initial research goals in 
purely scientific terms.  As a case in point, 
in the \textit{Data Integration} book mentioned previously 
the authors identified numerous innovative 
software projects --- e.g., the Digital Model 
Repository from the Cancer Biomedical Grid (\CaBIG{}) 
--- that were discontinued despite promising 
provisional results.  Other frameworks, such as 
...
technical and translational priorities.  Beyond 
originart research, the impetus 
for further development and adoption of promising 
software, interventions, or clinical protocols can 
be supplied by social responsibility and a 
desire to make effective health care options 
(for example) available to a broad spectrum of 
the community.  Research initially funded 
and supported on purely technical grounds might 
then be able to further develop and expand 
...
protocols such as Research Objects where supplemental 
materials (graphics, data sets, and so on) are presented 
...
\p{Here, \PacTk{} proposes a \q{Translational Research Object 
...
practices for emphasizing social benefits of research projects).
...
through downloaded resources/data sets.  
Materials associated through this entry 
...
whose responsibilities include assess the 
...
broader research community.  Examples include (among many others) \FASTQ{} and \VCF{} for genomics; \HDFfive{} and \ROOT{} for physics;
\FITS{} and \netCDF{} in astronomy and earth sciences; \PDB{} and \MOL{} in biochemistry; 
\IFC{} and \BIM{} for architecture/engineering; \SEGY{} and \BAG{} 
...
generic parsers may convert a given \XML{} document to a %Document Object Model 
...
can be isolated as cross-reference targets for data-structure parameters 
...
can be recorded as a unit, allowing relevant \ThreeD{} content to be 
...
Zoning and Land Use ordinances).  Conversely, \GIS{} attribute layers would represent 
