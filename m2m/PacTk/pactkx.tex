...
purely scientific terms.  In the \textit{Data Integration} book 
mentioned previously, 
the authors identified numerous innovative 
software initiatives --- e.g., the Digital Model 
Repository from the Cancer Biomedical Informatics Grid (\CaBIG{}) 
...
originary research, the impetus 
