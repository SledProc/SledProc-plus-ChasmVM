...
\p{At the same time, although there 
...
%\pseudoIndent{} 
\p{One difference between \PacTk{} and \JATS{} is that for \PacTk{} 
...
%\pseudoIndent{} 
\p{Also, as with \XML{}, \JSON{} is only computationally 
...
%\pseudoIndent{} 
\p{In itself, Markdown does not have sufficient 
...
\enlargethispage{1em}
\p{For these reasons, although offering many more 
...
\item[Research with Computational Requirements] As with 
...
\pseudoIndent{} There are many branches of economics, 
...
\item[Document Collections] Preserving historical documents 
...
\item[Interactive Graphics] Numerous use cases in humanities 
...
\item[Translational Science] Concerted efforts to \q{translate} 
...
\pseudoIndent{} Meanwhile, data modeling, meta-science, and document preparation 
