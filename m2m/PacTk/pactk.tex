...
sentence-boundary heuristics --- which can be overridden via 
...
Later sections will also address how \PacTk{} could contribute 
...
\begin{figure}[t]
\includegraphics[scale=0.83, trim=0 3cm 0 1cm, clip]{fin/single.png}
...
and stemming/lemmatization (Figure~\ref{fig:ss5}).
...
in a single \PDF{} document (Figure~\ref{fig:ss6}).
...
and statistical/data-visualization tools and diagrams).  If desired, 
