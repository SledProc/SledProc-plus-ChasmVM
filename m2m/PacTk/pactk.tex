...
\vspace{4pt}
Publishing Documents, Data Sets, and Multimedia Resources }}
%\sectvspace{}
...
\p{Given the limitations of \XML{} for natural-language 
...
sentence-boundary heuristics (that can be overridden via 
...
take responsibility for deserializing encoded data sets.  Depend 
...
rule-match callbacks) parsers for custom input file types.
...
runtimes allows query evaluators to recogonize basic 
...
\lPacTk{} can be beneficial this context 
