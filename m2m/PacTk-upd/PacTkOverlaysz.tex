...
\AtTextUpperLeft{\hspace{169pt}\raisebox{8pt}%
{\colorbox{white}{\toptxt{34pt}{Multimedia Plugins}}}}

}

\AtTextLowerLeft{\raisebox{157pt}{

\begin{tikzpicture}


\node [draw=fillc!80!cyan, fill=fillc!50!magenta, anchor = north west, rounded corners,
text width=5.84cm, inner sep=11pt, xshift=-8pt, yshift=-8pt, font={\fontsize{9}{9}\selectfont}] (stext)
at (0.2, 0.4) {{https://www.chemistryworld.com/news/plotting-a-course-to-new-antibiotics/3007780.article}
};


\node [draw=fillc!80!cyan, fill=white, anchor = north west, rounded corners,
text width=5.84cm, inner sep=8pt, font={\fontsize{9}{9}\selectfont}] (s)
 at (0, 0) {https://www.chemistryworld.com/news/plotting-a-course-to-new-antibiotics/3007780.article
};
...
\ifnum\value{page}=4{
\AtTextLowerLeft{\raisebox{215pt}{
...
text width=6cm, inner sep=19pt, xshift=-8pt, yshift=-8pt, font={\fontsize{9}{9}\selectfont}] (ltext)
 at (.64, 6.6) {{Creating an index for the 2nd edition of a book: 
all of the index entry 
...
the second edition if it had been indexed in the first.}
};
...
\AtTextUpperLeft{\raisebox{-29pt}%
{\toptxt{202pt}{Compiling Indexes}}}
...
\AtTextUpperLeft{\raisebox{8pt}%
{\colorbox{white}{\toptxt{34pt}{Meta-Index for Side-by-Side Reading of Multiple Books}}}}
...
\ifnum\value{page}=2{
\AtTextLowerLeft{\raisebox{229pt}{
...
\AtTextUpperLeft{\raisebox{-29pt}%
{\toptxt{80pt}{Navigation Handles for Finding Index Terms}}}
