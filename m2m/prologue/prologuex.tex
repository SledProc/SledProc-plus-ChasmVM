...
\prHead{17}{United{\prSa}Nations{\prSa}Addresses{\prSa}Family{\prSa}Courts'{\prSa}%
...
[\textit{sic}] using ‘parental alienation' in part due to increased
barriers in accessing justice as well as negative stereotypes.}\hspace{1pt}\fnm{7} \pfl{}

\vspace{3em}
\prHead{17}{Inside the Torture Chambers of the Family Courts: Forced
...
\qq{Infants are being penalized in the name of ‘men's rights.'\hspace{2pt}} Their letter
...
\vspace{3em}
\prHead{17}{Another{\prSb}Instance{\prSb}of{\prSb}Violence{\prSb}%
...
\prHead{17}{Ending Institutional Violence against Mothers and Children}
...
\prHead{16}{Protective Mother Movement Makes Great Strides in Recent Years}
...
\vspace{4em}
\prHead{17}{Plight of Protective Mothers Heeded in Academic Settings}
...
Violence Law Center (NFVLC) situated at George Washington University Law School. The Center's function is described as follows: \qq{using empirical research,
...
setting up \qq{a citizen review ‘second look' 
...
\vspace{3em}
\prHead{15}{Protective Mothers Finally Find a Sympathetic Ear in the Mass Media}
...
The article, aptly titled \qq{\hspace{2pt}‘A gendered trap,'\hspace{2pt}} quoted Meier,
who found a pattern of judges repeatedly placing children with the
abusive parent: \qq{Meier called the pattern a ‘complete betrayal of the
...
\prHead{16}{Feminist Writers and Researchers Come Together to Champion
...
\vspace*{1em}
\prHead{16}{Protective{\prSd}Mother{\prSd}Issue{\prSd}Gains{\prSd}%
...
\prHead{17}{Women's eNews Recognizes the Protective Mother Issue}
...
\prHead{16}{Protective Mother Movement Builds up Traction
...
%\prHead{16}{PROTECTIVE MOTHERS SUFFER TWO FOLD IN THE FAMILY COURTS}
...
\prHead{16.5}{Black, Indigenous, and People of Color Mothers Suffer Racial
...
\prHead{16}{The New Economic Realities of the Family Courts\mdash{}and How
...
\prHead{16}{Court-Ordered Visitation Used to Prevent the Child's Disclosures
from Investigation}
...
\prHead{16}{Visitation Centers Impose Undue Financial Hardship on Mothers}
...
\prHead{16}{Visitation Centers Impose Punitive Conditions on Mothers
and Children}
...
\prHead{16}{Family Court Arrogated by \qq{Ransom} Business Model Spanning
in Many Directions}
\vspace{-.5em}
...
\prPart{PART V\mdash{}NARRATIVE CASE HISTORIES AND COURT RECORDS: A LONGITUDINAL VERSUS A 
CROSS-SECTIONAL STUDY}

\prHead{15}{How the Second Edition is Organized, and How It is Distinguished
...
perhaps the greatest betrayal of battered women by the family courts. \pfl{}
