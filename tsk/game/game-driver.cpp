...
#include "variants/game-variant.h"
...
void Game_Driver::check_token_stone_icon(Game_Token* token)
{
 Stone_Icon* icon = nullptr;
...
// }
 ...
 case Game_Token::Token_Kind::North_Ace:
   icon = north_stone_icons_.value("ace-n%1"); break;
 case Game_Token::Token_Kind::North_Jack:
   icon = north_stone_icons_.value("jack-n%1"); break;
 case Game_Token::Token_Kind::North_Queen:
   icon = north_stone_icons_.value("queen-n%1"); break;
 case Game_Token::Token_Kind::North_King:
   icon = north_stone_icons_.value("king-n%1"); break;
 ...
 case Game_Token::Token_Kind::North_Singleton:
  {
   ...
   case Game_Position::Position_Kind::Center:
    icon = north_stone_icons_.value("bishop-n%1"); break;
   case Game_Position::Position_Kind::Intersection:
    icon = north_stone_icons_.value("knight-n%1"); break;
   case Game_Position::Position_Kind::Side:
   case Game_Position::Position_Kind::Edge:
    icon = north_stone_icons_.value("rook-n%1"); break;
   case Game_Position::Position_Kind::Slot:
    icon = north_stone_icons_.value("pawn-n%1"); break;
   default: break;
   }
  }
  break;
 ...
 case Game_Token::Token_Kind::South_Ace:
   icon = south_stone_icons_.value("ace-n%1"); break;
 case Game_Token::Token_Kind::South_Jack:
   icon = south_stone_icons_.value("jack-n%1"); break;
 case Game_Token::Token_Kind::South_Queen:
   icon = south_stone_icons_.value("queen-n%1"); break;
 case Game_Token::Token_Kind::South_King:
   icon = south_stone_icons_.value("king-n%1"); break;
 ...
 case Game_Token::Token_Kind::South_Singleton:
  {
   ...
   {
   case Game_Position::Position_Kind::Center:
    icon = south_stone_icons_.value("bishop-s%1"); break;
   case Game_Position::Position_Kind::Intersection:
    icon = south_stone_icons_.value("knight-s%1"); break;
   case Game_Position::Position_Kind::Side:
   case Game_Position::Position_Kind::Edge:
    icon = south_stone_icons_.value("rook-s%1"); break;
   case Game_Position::Position_Kind::Slot:
    icon = south_stone_icons_.value("pawn-s%1"); break;
   default: break;
   }
  }
 default: break;
...
//  check_token_stone_icon(token);

// //? dlg.run_js_in_current_web_page("show_stone_icon('%1','%2')"_qt.arg(mid).arg(tid));
...
void Game_Driver::register_north_stone_icon(QString file_path, QString svg_id)
{
 north_stone_icons_[svg_id] = new Stone_Icon {file_path, svg_id};
}

void Game_Driver::register_south_stone_icon(QString file_path, QString svg_id)
{
 south_stone_icons_[svg_id] = new Stone_Icon {file_path, svg_id};
}
...
{
 if(current_indicator_status_ == Indicator_Status::Stone_Icons)
   run_js_code(dlg, "hide_stone_icons()");
...
void Game_Driver::show_stone_icon(const QH_Web_View_Dialog& dlg,
  Game_Token* token)
{
 if(Game_Driver::Stone_Icon* icon = tokens_on_board_.value(token))
   show_stone_icon(dlg, token, icon);
}
  ...
  Game_Token* token, Game_Driver::Stone_Icon* icon)
{
 ...
 dlg.run_js_in_current_web_page("show_stone_icon('%1','%2', %3)"_qt
   .arg(id).arg(tid)
   .arg(current_indicator_status_ == Indicator_Status::Stone_Icons? "true" : "false"));

// qDebug() << "show_stone_icon('%1','%2')"_qt.arg(id).arg(tid);
}


void Game_Driver::hide_stone_icons(const QH_Web_View_Dialog& dlg)
{
 current_indicator_status_ = Indicator_Status::N_A;
 run_js_code(dlg, "hide_stone_icons()");
}
...
void Game_Driver::show_stone_icons(const QH_Web_View_Dialog& dlg)
{
 if(current_indicator_status_ == Indicator_Status::Text)
   run_js_code(dlg, "hide_text_indicators()");

 current_indicator_status_ = Indicator_Status::Stone_Icons;
...
void Game_Driver::handle_position_context_menu(QH_Web_View_Dialog& dlg,  QString position_id, const QPoint& global_position)
{
 ...
 menu->addAction("Show Stone Icons", [this, &dlg]()
 {
  show_stone_icons(dlg);
 });

 menu->addAction("Hide Stone Icons", [this, &dlg]()
 {
  hide_stone_icons(dlg);
 });
