...
## grab SRC_PROSET_DIR from prelim
prelim_SRC_PROSET_DIR = $$SRC_PROSET_DIR
prelim_SRC_PROSET_DIR ~= s!/code/cpp/src/exp!/code/cpp/src/prelim!

INCLUDEPATH += $$clean_path($${prelim_SRC_PROSET_DIR}/../qmt-apache/qmt-native-client/MapGraphics)
...
prelim_NTXH_SRC_GROUP_DIR = $$NTXH_SRC_GROUP_DIR
prelim_NTXH_SRC_GROUP_DIR ~= s!/code/cpp/src/exp!/code/cpp/src/prelim!

INCLUDEPATH += $$prelim_NTXH_SRC_GROUP_DIR
INCLUDEPATH += $$prelim_NTXH_SRC_GROUP_DIR/ntxh



prelim_RELAE_GRAPH_SRC_GROUP_DIR = $$RELAE_GRAPH_SRC_GROUP_DIR
prelim_RELAE_GRAPH_SRC_GROUP_DIR ~= s!/code/cpp/src/exp!/code/cpp/src/prelim!

INCLUDEPATH += $$prelim_RELAE_GRAPH_SRC_GROUP_DIR



prelim_PHAON_GRAPH_SRC_GROUP_DIR = $$PHAON_GRAPH_SRC_GROUP_DIR
prelim_PHAON_GRAPH_SRC_GROUP_DIR ~= s!/code/cpp/src/exp!/code/cpp/src/prelim!

INCLUDEPATH += $$prelim_PHAON_GRAPH_SRC_GROUP_DIR
