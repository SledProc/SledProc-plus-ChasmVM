...
#define TEMP_MACRO(X, Y) {Y, MS_Token_Kinds::X},
    ...
    TEMP_MACRO(Scoped_Symbol, "scs")
    TEMP_MACRO(String_Literal, "slt")
    TEMP_MACRO(Literal, "lit")
    TEMP_MACRO(FGround_Symbol, "fgs")
    TEMP_MACRO(Raw_Symbol, "raw")
    TEMP_MACRO(Bridge_Symbol, "brs")
    TEMP_MACRO(Sigma_Symbol, "sig")
    TEMP_MACRO(Internal_String, "ins")
    TEMP_MACRO(Skip_Token, "skt")
    TEMP_MACRO(Type_Symbol, "typ")
    TEMP_MACRO(Kernel_Type_Symbol, "kty")
    TEMP_MACRO(Nested_Forward, "nsf")
    TEMP_MACRO(Nested_Back, "nsb")
    TEMP_MACRO(Paren_Entry, "pre")
    TEMP_MACRO(Paren_Leave, "prl")
    TEMP_MACRO(Note_Symbol, "not")
    TEMP_MACRO(Proxy_Value_Symbol, "pvs")
    TEMP_MACRO(Assignment_Kind, "ask")
