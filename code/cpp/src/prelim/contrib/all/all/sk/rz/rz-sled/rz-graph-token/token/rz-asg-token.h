...
#ifndef RZ_ASG_TOKEN__H
#define RZ_ASG_TOKEN__H
...
#define tv_type_is(Type_exp, to_sym, tv_sym) \
 ...
 void redirect_asg(QString str, RZ_ASG_Node& node);
 void redirect_asg_in_form(QString str, RZ_ASG_Node& node);
