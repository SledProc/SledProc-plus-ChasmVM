...
#ifndef CHASM_RZ_TOKEN__H
#define CHASM_RZ_TOKEN__H
...
private:
 ...
 ChasmRZ_Code_Representation::Special_Token special_token_;
...
public:
 ...
 ACCESSORS(caon_ptr<RZ_ASG_Token> ,asg_token)
 ...
 QString get_asg_out() const;

 QString special_token_kind_string() const;

 ChasmRZ_Code_Representation::Special_Token_Kind special_token_kind() const
 {
 ...
 ChasmRZ_Code_Representation::Special_Tokens special_token()
 {
