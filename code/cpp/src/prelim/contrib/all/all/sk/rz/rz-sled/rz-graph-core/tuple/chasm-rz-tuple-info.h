...
#ifndef CHASM_RZ_TUPLE_INFO__H
#define CHASM_RZ_TUPLE_INFO__H
...
public:
 ...
 ChasmRZ_Tuple_Info(Tuple_Formations tf, Tuple_Indicators ti, int data_id);

 QString asg_out(bool with_prefix = false) const;

 QString asg_out_with_id(bool with_prefix = false) const;
