...
#ifndef RZ_ASG_VALUE_HOLDER__H
#define RZ_ASG_VALUE_HOLDER__H
...
private:
 ...
 ChasmRZ_Galaxy::Root_Vertex_type value_;
 caon_ptr<RZ_Type_Object> type_object_;

public:

 ACCESSORS__GET(ChasmRZ_Galaxy::Root_Vertex_type ,value)
 ACCESSORS(caon_ptr<RZ_Type_Object> ,type_object)
   ...
   {
#ifdef NO_CAON
    value_ = reinterpret_cast<ChasmRZ_Galaxy::Root_Vertex_type> ( t );
#else
    value_ = t.template caon_cast<ChasmRZ_Galaxy::Root_Vertex_type>();
#endif
   }
