...
#ifndef CHASM_RZ_CODE_REPRESENTATION__H
#define CHASM_RZ_CODE_REPRESENTATION__H
...
class ChasmRZ_Code_Representation
{
...
public:
 ...
 {
  N_A
  #define CHASMRZ_SPECIAL_TOKEN(token, cpp_enum, kind) \
   ,cpp_enum
  #define CHASMRZ_SPECIAL_TOKEN_RENAME(token, cpp_enum, kind) \
   ,cpp_enum
  # include "chasm-rz-code-representation.special-tokens.h"
  #undef CHASMRZ_SPECIAL_TOKEN_RENAME
  #undef CHASMRZ_SPECIAL_TOKEN
 };
...
#endif //CHASM_RZ_CODE_REPRESENTATION__H
