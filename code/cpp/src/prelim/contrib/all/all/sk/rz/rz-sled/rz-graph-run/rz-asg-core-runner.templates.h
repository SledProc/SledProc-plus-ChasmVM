...
template<>
void RZ_ASG_Core_Runner::run<RZ_Graph_Call_CV>(RZ_ASG_Result_Holder& rh, RZ_ASG_Function_Code function_code,
 RZ_ASG_Value_Holder& lhs_value, RZ_ASG_Value_Holder& rhs_value)
{
 CAON_DEBUG_NOOP
...
template<>
void RZ_ASG_Core_Runner::run<RZ_Graph_Call_CV>(RZ_ASG_Result_Holder& rh,
 RZ_ASG_Function_Code function_code,
 RZ_ASG_Token& lhs_token, RZ_ASG_Value_Holder& v2)
{
 switch(function_code)
 {
  RZ_TEMP_CASES__FUNCTION_CODE
