...
#ifndef CHASM_RZ_CALL_ENTRY__H
#define CHASM_RZ_CALL_ENTRY__H
...
public:
 ...
 ChasmRZ_Call_Entry(int call_id, QString prefix = QString());
 ...
 caon_ptr<ChasmRZ_Node> get_next_entry_node(caon_ptr<ChasmRZ_Call_Entry>& next_call_entry, int& unwind_count);
