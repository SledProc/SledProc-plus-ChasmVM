...
//? needed any more?
caon_ptr<RZ_Lisp_Graph_Block_Info> RZ_Lisp_Graph_Visitor_Dynamo::block_info_from_block_entry_node(caon_ptr<ChasmRZ_Node> ben)
{
...
caon_ptr<RZ_Lisp_Graph_Block_Info> RZ_Lisp_Graph_Visitor_Dynamo::check_pending_block_info(caon_ptr<ChasmRZ_Node> node)
{
...
void RZ_Lisp_Graph_Visitor_Dynamo::check_assignment_annotation(caon_ptr<ChasmRZ_Node> statement_entry_node,
...
caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::get_next_node(caon_ptr<ChasmRZ_Node> start_node,
...
caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::get_next_statement_node(caon_ptr<ChasmRZ_Node> sen)
{
...
caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::leave_nested_block(caon_ptr<RZ_Lisp_Graph_Block_Info> rbi, caon_ptr<RZ_Lisp_Graph_Block_Info>& nn_bi)
{
 if(rbi)
 {
...
caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::block_entry_node_from_function_def_entry_node(caon_ptr<ChasmRZ_Node> start_node)
{
 CAON_PTR_DEBUG(ChasmRZ_Node ,start_node)
...
caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::call_entry_node_from_block_entry_node(caon_ptr<ChasmRZ_Node> start_node)
{
 CAON_PTR_DEBUG(ChasmRZ_Node ,start_node)
 return visitor_.call_entry_from_node(start_node);
}

caon_ptr<RZ_Function_Def_Info> RZ_Lisp_Graph_Visitor_Dynamo::get_function_def_info_from_entry(caon_ptr<ChasmRZ_Function_Def_Entry> fde)
{
...
caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::start_node_from_call_entry_node(caon_ptr<ChasmRZ_Node> entry_node)
{
 return visitor_.entry_from_call_entry(entry_node);
}

caon_ptr<ChasmRZ_Node> RZ_Lisp_Graph_Visitor_Dynamo::find_statement_cross_sequence_node(caon_ptr<ChasmRZ_Node> start_node)
{
 CAON_PTR_DEBUG(ChasmRZ_Node ,start_node)
