...
#include "rz-asg-result-holder.h"
...
RZ_ASG_Result_Holder::RZ_ASG_Result_Holder(RZ_ASG_Valuer& valuer)
 : Flags(0), valuer_(valuer), arity_node_(nullptr), arity_value_node_(nullptr),
   pass_node_(nullptr), lead_function_node_(nullptr)
{
}

void RZ_ASG_Result_Holder::hold(caon_ptr<tNode> n)
{
 current_start_nodes_.push(n);
}

void RZ_ASG_Result_Holder::unhold()
{
 current_start_nodes_.pop();
}

caon_ptr<RZ_ASG_Result_Holder::tNode>
RZ_ASG_Result_Holder::pull_pass_node()
{
...
void RZ_ASG_Result_Holder::continue_proceed(caon_ptr<tNode> n)
{
...
caon_ptr<RZ_ASG_Result_Holder::tNode>
 RZ_ASG_Result_Holder::function_node()
{
...
void RZ_ASG_Result_Holder::mark_continue_statement(caon_ptr<tNode> n, caon_ptr<tNode> vn)
{
 CAON_PTR_DEBUG(tNode ,n)
...
void RZ_ASG_Result_Holder::mark_continue_statement(caon_ptr<tNode> n)
{
 CAON_PTR_DEBUG(tNode ,n)
 flags.continue_statement = true;
 arity_node_ = n;
...
caon_ptr<RZ_ASG_Result_Holder::tNode>
 RZ_ASG_Result_Holder::get_lead_function_node(caon_ptr<tNode> current_start_node)
{
 if(lead_function_node_)
...
void RZ_ASG_Result_Holder::skip_redirect()
{
